...
@Schema(name = "Customer Details", description = "Customer details, Accounts, Loans and Cards information")
@Builder
...
public record CustomerDetailsDto(
        ...
        @Schema(description = "Loan details associated with the customer")
        LoanDto loanDto,

        @Schema(description = "Card details associated with the customer")
        CardDto cardDto
